      ...
      <el-card>
        <el-tabs type="border-card">
          ...
          <el-tab-pane label="个人详情">
            ...
            <!-- <user-info /> -->
            <!-- vuejs 内置了一个 动态组件 component 可以是任何组件 -->
            <!-- 动态组件 -> 可以切换组件 例：反复横跳 -->
            <!-- <el-button type="primary" @click="UserComponent = 'el-button'">切换组件1</el-button> -->
...
export default {
  ...
  data() {
    return {
      // is属性可以直接为注册组件的组件名称(规定 is 必须是变量)
      ...
      userInfo: {
        // 专门存放基本信息
        username: '',
        password2: '' // 定义password2 因为接口的缺陷问题，读取出来的 password是密文
      },
      rules: {
